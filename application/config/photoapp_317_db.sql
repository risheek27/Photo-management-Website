...
--
-- Host: localhost    Database: photoapp-db
-- ------------------------------------------------------
...
CREATE TABLE `posts` (
  ...
  KEY `users post_idx` (`fk_userid`),
  CONSTRAINT `users post` FOREIGN KEY (`fk_userid`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-12-23 13:17:50
